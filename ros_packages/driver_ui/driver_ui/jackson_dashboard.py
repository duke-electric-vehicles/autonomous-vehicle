    ...
    def run(self):
        ...
        while not done:
            ...
            if self.show_camera:
                ...
                self.draw_text(
                    stopwatch_text, self.font_large, self.WHITE, 120, stopwatch_y
                )
                self.draw_text(
                    "Lat: " + f"{self.lat:.5f}",
                    self.font_large,
