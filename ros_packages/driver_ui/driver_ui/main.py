"""
Duke Electric Vehicles User Interface
By: Owen Jennings

Used OpenAI Codex and https://github.com/tisljaricleo/GPS-visualization-Python
"""
...
def main():
    ...
    current_car_position = random.choice(points) # set current car position to a random point for now
    current_car_rotation = 0 # set current car rotation to be pointed straight NORTH
    draw_points(points, current_car_position, current_car_rotation)
