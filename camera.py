    ...
    def run(self):
        ...
        while not done:
            ...
            if self.show_camera:
                ...
                self.display_camera()
                self.draw_text(stopwatch_text, self.font_xlarge, self.WHITE, 175, 500)
            ...
            logo = pygame.transform.scale(logo, (125, 125))
            logo_flip = pygame.transform.flip(logo, True, False)
            self.screen.blit(logo_flip, (10, 480))
            self.screen.blit(logo, (355, 480))
